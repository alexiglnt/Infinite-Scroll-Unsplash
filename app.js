...
const accessKey = "2KSV3zcC-HzyDvpmg0ScWPCN826BS63g9SXl7Ys1vvc";
const secretKey = "66UUuG6pFVgW-z4OLUzqKhfB9GFhWFoSirKWFFglf6I";


async function fetchData() {
    try {
        const response = await fetch(`https://api.unsplash.com/search/photos?page=${pageIndex}&per_page=30&query=${searchQuery}&client_id=2KSV3zcC-HzyDvpmg0ScWPCN826BS63g9SXl7Ys1vvc`);
